...
public class AddPlayerAPI {
    ...
    AddPlayerAPI(Context ctx, int typeID, String title, String gameCode, String TourneyID, String name){
        ...
        */
        String apiCall="https://api.binarybeast.com/?APIService=Tourney.TourneyTeam.Insert&APIReturn=json&APIKey=4904a28e5c92f5919f7fcc2e716597e8.5350362f7b2669.06156210&TourneyID="+TourneyID+"&DisplayName="+"Toto";
